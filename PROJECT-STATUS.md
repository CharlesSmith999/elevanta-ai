...
Finish the remaining Milestone 1 deployment checks and begin the real Supabase-backed Milestone 2 import path. The first import must use staging, preserve workbook/tab/row provenance, apply deterministic duplicate handling, and be validated before any records enter active routing.
