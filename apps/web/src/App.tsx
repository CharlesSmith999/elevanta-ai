...
import { IconActivityHeartbeat, IconAddressBook, IconAlertTriangle, IconArrowUpRight, IconBriefcase, IconBuilding, IconBulb, IconCalendar, IconChartBar, IconChartPieFilled, IconChecklist, IconCircleCheck, IconClock, IconCurrencyDollar, IconFilter, IconFlag, IconHelpCircle, IconHome, IconMoonStars, IconReportAnalytics, IconRobot, IconRocket, IconSettings, IconSparkles, IconSun, IconTarget, IconTargetArrow, IconTrophy, IconTrendingUp, IconUserCircle, IconUsers } from '@tabler/icons-react';
