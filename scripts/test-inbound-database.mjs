...
await db.exec('reset role');
await db.query("insert into gmail_connections(workspace_id,mailbox,encrypted_refresh_token,enabled,activated_at,connected_by) values($1,'synthetic@example.invalid','encrypted-fixture',true,now()-interval '1 hour',$2)",['10000000-0000-4000-8000-000000000001',admin]);
